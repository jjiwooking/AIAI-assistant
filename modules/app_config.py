...
TEXT_DEFAULTS = {
    ...
    # 이메일
    "email_title": ("이메일", "화면 제목", "📄 PDF 메일 작성!"),
    "email_upload_label": ("이메일", "파일 업로드 문구", "📄 PDF 또는 문서 파일 업로드 (선택)"),
    "email_situation_label": ("이메일", "상황 설명 제목", "📝 상황 설명 / 공문 본문 / 추가 지시사항"),
    "email_situation_placeholder": ("이메일", "상황 설명 예시", "예: 거래처에 계약서 서명 요청 메일을 정중하게 작성"),
    "email_tone_label": ("이메일", "톤 선택 제목", "🎭 톤 및 변환 목적"),
    "email_tone_formal": ("이메일", "톤 - 공식", "공식적·정중하게"),
    "email_tone_summary": ("이메일", "톤 - 공문 요약", "📜 공문/안내문 → 핵심 요약 전달 메일"),
    "email_tone_internal": ("이메일", "톤 - 사내 공지", "🏢 사내/팀 공지 메일"),
    "email_tone_customer": ("이메일", "톤 - 고객 협조", "🤝 거래처/고객사 협조 요청"),
    "email_tone_friendly": ("이메일", "톤 - 친근", "친근하고 부드럽게"),
    "email_tone_concise": ("이메일", "톤 - 간결", "간결하게 (핵심만)"),
    "email_tone_apology": ("이메일", "톤 - 사과", "사과/양해 구하기"),
    "email_additional_label": ("이메일", "추가 요청 제목", "➕ 추가 요청 (선택)"),
    "email_additional_placeholder": ("이메일", "추가 요청 예시", "예: 마감일 강조 / 3줄 요약 포함 / 영문 번역 병기"),
    "email_generate_button": ("이메일", "생성 버튼", "✉️ 이메일 자동 생성 / PDF 변환"),
    "email_result_title": ("이메일", "결과 영역 제목", "📨 완성된 이메일"),
    "email_missing_input": ("이메일", "입력 누락 경고", "⚠️ PDF 파일을 업로드하거나 상황/공문 내용을 텍스트로 입력해주세요."),
    "email_spinner": ("이메일", "생성 중 문구", "AI가 PDF 원본 문서를 정밀 분석하여 이메일을 작성 중입니다..."),
    "email_empty_guide": ("이메일", "결과 영역 안내", "왼쪽에서 PDF 파일을 올리거나 내용을 입력한 뒤 이메일 생성 버튼을 눌러주세요."),
